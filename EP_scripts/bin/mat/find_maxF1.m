...
niftiF1 = niftiread(sprintf('%s/models/glmN-DCT/spmF_0001.nii',route));

maskIm = niftiread(sprintf('%s/masks/s-rfMRI_mask.nii',route));
clear("matlabbatch")

%Clean up mask image, as nan will create errors with VOI calculations
fprintf("cleaning up mask for route %s",route)
for t=1:410
    v_pad = sprintf('%04d',t);
    timeseriesIm = niftiread(sprintf('%s/models/glmN-DCT/Res_%s.nii',route,v_pad));
    for x=1:91
        for y=1:109
            for z=1:91
...
fprintf('mask cleaning complete for route %s',route)
...
%... save to txt file along with route number
...
save(sprintf('%s/positions_of_MaxFs/coords_PCCandPrecuneus.txt',route),"subject","pos_maxPCCandPrecuneus", "val_PCCandPrecuneus",'-append','-ascii');
save(sprintf('%s/positions_of_MaxFs/coords_mPFC.txt',route),"subject","pos_maxmPFC","val_mPFC",'-append','-ascii');
save(sprintf('%s/positions_of_MaxFs/coords_LlPar.txt',route),"subject","pos_maxLlPar","val_L_lPar",'-append','-ascii');
save(sprintf('%s/positions_of_MaxFs/coords_RlPar.txt',route),"subject","pos_maxRlPar","val_R_lPar",'-append','-ascii');
save(sprintf('%s/positions_of_MaxFs/coords_LiTem.txt',route),"subject","pos_maxLiTem","val_L_iTem",'-append','-ascii');
save(sprintf('%s/positions_of_MaxFs/coords_RiTem.txt',route),"subject","pos_maxRiTem","val_R_iTem",'-append','-ascii');
save(sprintf('%s/positions_of_MaxFs/coords_mdThal.txt',route),"subject","pos_maxmdThal","val_mdThal",'-append','-ascii');
save(sprintf('%s/positions_of_MaxFs/coords_LpCerb.txt',route),"subject","pos_maxLpCerb","val_L_pCerb",'-append','-ascii');
save(sprintf('%s/positions_of_MaxFs/coords_RpCerb.txt',route),"subject","pos_maxRpCerb","val_R_pCerb",'-append','-ascii');
save(sprintf('%s/positions_of_MaxFs/coords_dmPFC.txt',route),"subject","pos_maxdmPFC","val_dmPFC",'-append','-ascii');
save(sprintf('%s/positions_of_MaxFs/coords_LaPFC.txt',route),"subject","pos_maxLaPFC","val_L_aPFC",'-append','-ascii');
save(sprintf('%s/positions_of_MaxFs/coords_RaPFC.txt',route),"subject","pos_maxRaPFC","val_R_aPFC",'-append','-ascii');
save(sprintf('%s/positions_of_MaxFs/coords_LsPar.txt',route),"subject","pos_maxLsPar","val_L_sPar",'-append','-ascii');
save(sprintf('%s/positions_of_MaxFs/coords_RsPar.txt',route),"subject","pos_maxRsPar","val_R_sPar",'-append','-ascii');
save(sprintf('%s/positions_of_MaxFs/coords_dACC.txt',route),"subject","pos_maxdACC","val_dACC",'-append','-ascii');
save(sprintf('%s/positions_of_MaxFs/coords_LaPFC_SN.txt',route),"subject","pos_maxLaPFC_SN","val_L_aPFC_SN",'-append','-ascii');
save(sprintf('%s/positions_of_MaxFs/coords_R_aPFC_SN.txt',route),"subject","pos_maxRaPFC_SN","val_R_aPFC_SN",'-append','-ascii');
save(sprintf('%s/positions_of_MaxFs/coords_LIns.txt',route),"subject","pos_maxLIns","val_L_Ins",'-append','-ascii');
save(sprintf('%s/positions_of_MaxFs/coords_RIns.txt',route),"subject","pos_maxRIns","val_R_Ins",'-append','-ascii');
save(sprintf('%s/positions_of_MaxFs/coords_LlPar_SN.txt',route),"subject","pos_maxLlPar_SN","val_L_lPar_SN",'-append','-ascii');
save(sprintf('%s/positions_of_MaxFs/coords_RlPar_SN.txt',route),"subject","pos_maxRlPar_SN","val_R_lPar_SN",'-append','-ascii');
...
save(sprintf('%s/positions_of_MaxFs/mmcoords_PCCandPrecuneus.txt',route),"subject","mm_pos_maxPCCandPrecuneus", "val_PCCandPrecuneus",'-append','-ascii');
save(sprintf('%s/positions_of_MaxFs/mmcoords_mPFC.txt',route),"subject","mm_pos_maxmPFC","val_mPFC",'-append','-ascii');
save(sprintf('%s/positions_of_MaxFs/mmcoords_LlPar.txt',route),"subject","mm_pos_maxLlPar","val_L_lPar",'-append','-ascii');
save(sprintf('%s/positions_of_MaxFs/mmcoords_RlPar.txt',route),"subject","mm_pos_maxRlPar","val_R_lPar",'-append','-ascii');
save(sprintf('%s/positions_of_MaxFs/mmcoords_LiTem.txt',route),"subject","mm_pos_maxLiTem","val_L_iTem",'-append','-ascii');
save(sprintf('%s/positions_of_MaxFs/mmcoords_RiTem.txt',route),"subject","mm_pos_maxRiTem","val_R_iTem",'-append','-ascii');
save(sprintf('%s/positions_of_MaxFs/mmcoords_mdThal.txt',route),"subject","mm_pos_maxmdThal","val_mdThal",'-append','-ascii');
save(sprintf('%s/positions_of_MaxFs/mmcoords_LpCerb.txt',route),"subject","mm_pos_maxLpCerb","val_L_pCerb",'-append','-ascii');
save(sprintf('%s/positions_of_MaxFs/mmcoords_RpCerb.txt',route),"subject","mm_pos_maxRpCerb","val_R_pCerb",'-append','-ascii');
save(sprintf('%s/positions_of_MaxFs/mmcoords_dmPFC.txt',route),"subject","mm_pos_maxdmPFC","val_dmPFC",'-append','-ascii');
save(sprintf('%s/positions_of_MaxFs/mmcoords_LaPFC.txt',route),"subject","mm_pos_maxLaPFC","val_L_aPFC",'-append','-ascii');
save(sprintf('%s/positions_of_MaxFs/mmcoords_RaPFC.txt',route),"subject","mm_pos_maxRaPFC","val_R_aPFC",'-append','-ascii');
save(sprintf('%s/positions_of_MaxFs/mmcoords_LsPar.txt',route),"subject","mm_pos_maxLsPar","val_L_sPar",'-append','-ascii');
save(sprintf('%s/positions_of_MaxFs/mmcoords_RsPar.txt',route),"subject","mm_pos_maxRsPar","val_R_sPar",'-append','-ascii');
save(sprintf('%s/positions_of_MaxFs/mmcoords_dACC.txt',route),"subject","mm_pos_maxdACC","val_dACC",'-append','-ascii');
save(sprintf('%s/positions_of_MaxFs/mmcoords_LaPFC_SN.txt',route),"subject","mm_pos_maxLaPFC_SN","val_L_aPFC_SN",'-append','-ascii');
save(sprintf('%s/positions_of_MaxFs/mmcoords_R_aPFC_SN.txt',route),"subject","mm_pos_maxRaPFC_SN","val_R_aPFC_SN",'-append','-ascii');
save(sprintf('%s/positions_of_MaxFs/mmcoords_LIns.txt',route),"subject","mm_pos_maxLIns","val_L_Ins",'-append','-ascii');
save(sprintf('%s/positions_of_MaxFs/mmcoords_RIns.txt',route),"subject","mm_pos_maxRIns","val_R_Ins",'-append','-ascii');
save(sprintf('%s/positions_of_MaxFs/mmcoords_LlPar_SN.txt',route),"subject","mm_pos_maxLlPar_SN","val_L_lPar_SN",'-append','-ascii');
save(sprintf('%s/positions_of_MaxFs/mmcoords_RlPar_SN.txt',route),"subject","mm_pos_maxRlPar_SN","val_R_lPar_SN",'-append','-ascii');

niftInfo_mask = niftiinfo(sprintf('%s/masks/s-rfMRI_mask.nii',route));
niftiwrite(maskIm,sprintf('%s/masks/adjusted_s-rfMRI_mask.nii',route),niftInfo_mask);

matlabbatch{1}.spm.util.voi.spmmat = {sprintf('%s/models/glmN-DCT/SPM.mat',route)};
...
matlabbatch{1}.spm.util.voi.roi{2}.mask.image = {sprintf('%s/masks/adjusted_s-rfMRI_mask.nii,1',route)};
matlabbatch{1}.spm.util.voi.roi{2}.mask.threshold = 0.5;
matlabbatch{1}.spm.util.voi.expression = 'i1&i2';
matlabbatch{2}.spm.util.voi.spmmat = {sprintf('%s/models/glmN-DCT/SPM.mat',route)};
...
matlabbatch{2}.spm.util.voi.roi{2}.mask.image = {sprintf('%s/masks/adjusted_s-rfMRI_mask.nii,1',route)};
matlabbatch{2}.spm.util.voi.roi{2}.mask.threshold = 0.5;
matlabbatch{2}.spm.util.voi.expression = 'i1&i2';
matlabbatch{3}.spm.util.voi.spmmat = {sprintf('%s/models/glmN-DCT/SPM.mat',route)};
...
matlabbatch{3}.spm.util.voi.roi{2}.mask.image = {sprintf('%s/masks/adjusted_s-rfMRI_mask.nii,1',route)};
matlabbatch{3}.spm.util.voi.roi{2}.mask.threshold = 0.5;
matlabbatch{3}.spm.util.voi.expression = 'i1&i2';
matlabbatch{4}.spm.util.voi.spmmat = {sprintf('%s/models/glmN-DCT/SPM.mat',route)};
...
matlabbatch{4}.spm.util.voi.roi{2}.mask.image = {sprintf('%s/masks/adjusted_s-rfMRI_mask.nii,1',route)};
matlabbatch{4}.spm.util.voi.roi{2}.mask.threshold = 0.5;
matlabbatch{4}.spm.util.voi.expression = 'i1&i2';
matlabbatch{5}.spm.util.voi.spmmat = {sprintf('%s/models/glmN-DCT/SPM.mat',route)};
...
matlabbatch{5}.spm.util.voi.roi{2}.mask.image = {sprintf('%s/masks/adjusted_s-rfMRI_mask.nii,1',route)};
matlabbatch{5}.spm.util.voi.roi{2}.mask.threshold = 0.5;
matlabbatch{5}.spm.util.voi.expression = 'i1&i2';
matlabbatch{6}.spm.util.voi.spmmat = {sprintf('%s/models/glmN-DCT/SPM.mat',route)};
...
matlabbatch{6}.spm.util.voi.roi{2}.mask.image = {sprintf('%s/masks/adjusted_s-rfMRI_mask.nii,1',route)};
matlabbatch{6}.spm.util.voi.roi{2}.mask.threshold = 0.5;
matlabbatch{6}.spm.util.voi.expression = 'i1&i2';
matlabbatch{7}.spm.util.voi.spmmat = {sprintf('%s/models/glmN-DCT/SPM.mat',route)};
...
matlabbatch{7}.spm.util.voi.roi{2}.mask.image = {sprintf('%s/masks/adjusted_s-rfMRI_mask.nii,1',route)};
matlabbatch{7}.spm.util.voi.roi{2}.mask.threshold = 0.5;
matlabbatch{7}.spm.util.voi.expression = 'i1&i2';
matlabbatch{8}.spm.util.voi.spmmat = {sprintf('%s/models/glmN-DCT/SPM.mat',route)};
...
matlabbatch{8}.spm.util.voi.roi{2}.mask.image = {sprintf('%s/masks/adjusted_s-rfMRI_mask.nii,1',route)};
matlabbatch{8}.spm.util.voi.roi{2}.mask.threshold = 0.5;
matlabbatch{8}.spm.util.voi.expression = 'i1&i2';
matlabbatch{9}.spm.util.voi.spmmat = {sprintf('%s/models/glmN-DCT/SPM.mat',route)};
...
matlabbatch{9}.spm.util.voi.roi{2}.mask.image = {sprintf('%s/masks/adjusted_s-rfMRI_mask.nii,1',route)};
matlabbatch{9}.spm.util.voi.roi{2}.mask.threshold = 0.5;
matlabbatch{9}.spm.util.voi.expression = 'i1&i2';
matlabbatch{10}.spm.util.voi.spmmat = {sprintf('%s/models/glmN-DCT/SPM.mat',route)};
...
matlabbatch{10}.spm.util.voi.roi{2}.mask.image = {sprintf('%s/masks/adjusted_s-rfMRI_mask.nii,1',route)};
matlabbatch{10}.spm.util.voi.roi{2}.mask.threshold = 0.5;
matlabbatch{10}.spm.util.voi.expression = 'i1&i2';
matlabbatch{11}.spm.util.voi.spmmat = {sprintf('%s/models/glmN-DCT/SPM.mat',route)};
...
matlabbatch{11}.spm.util.voi.roi{2}.mask.image = {sprintf('%s/masks/adjusted_s-rfMRI_mask.nii,1',route)};
matlabbatch{11}.spm.util.voi.roi{2}.mask.threshold = 0.5;
matlabbatch{11}.spm.util.voi.expression = 'i1&i2';
matlabbatch{12}.spm.util.voi.spmmat = {sprintf('%s/models/glmN-DCT/SPM.mat',route)};
...
matlabbatch{12}.spm.util.voi.roi{2}.mask.image = {sprintf('%s/masks/adjusted_s-rfMRI_mask.nii,1',route)};
matlabbatch{12}.spm.util.voi.roi{2}.mask.threshold = 0.5;
matlabbatch{12}.spm.util.voi.expression = 'i1&i2';
matlabbatch{13}.spm.util.voi.spmmat = {sprintf('%s/models/glmN-DCT/SPM.mat',route)};
...
matlabbatch{13}.spm.util.voi.roi{2}.mask.image = {sprintf('%s/masks/adjusted_s-rfMRI_mask.nii,1',route)};
matlabbatch{13}.spm.util.voi.roi{2}.mask.threshold = 0.5;
matlabbatch{13}.spm.util.voi.expression = 'i1&i2';
matlabbatch{14}.spm.util.voi.spmmat = {sprintf('%s/models/glmN-DCT/SPM.mat',route)};
...
matlabbatch{14}.spm.util.voi.roi{2}.mask.image = {sprintf('%s/masks/adjusted_s-rfMRI_mask.nii,1',route)};
matlabbatch{14}.spm.util.voi.roi{2}.mask.threshold = 0.5;
matlabbatch{14}.spm.util.voi.expression = 'i1&i2';
matlabbatch{15}.spm.util.voi.spmmat = {sprintf('%s/models/glmN-DCT/SPM.mat',route)};
...
matlabbatch{15}.spm.util.voi.roi{2}.mask.image = {sprintf('%s/masks/adjusted_s-rfMRI_mask.nii,1',route)};
matlabbatch{15}.spm.util.voi.roi{2}.mask.threshold = 0.5;
matlabbatch{15}.spm.util.voi.expression = 'i1&i2';
matlabbatch{16}.spm.util.voi.spmmat = {sprintf('%s/models/glmN-DCT/SPM.mat',route)};
...
matlabbatch{16}.spm.util.voi.roi{2}.mask.image = {sprintf('%s/masks/adjusted_s-rfMRI_mask.nii,1',route)};
matlabbatch{16}.spm.util.voi.roi{2}.mask.threshold = 0.5;
matlabbatch{16}.spm.util.voi.expression = 'i1&i2';
matlabbatch{17}.spm.util.voi.spmmat = {sprintf('%s/models/glmN-DCT/SPM.mat',route)};
...
matlabbatch{17}.spm.util.voi.roi{2}.mask.image = {sprintf('%s/masks/adjusted_s-rfMRI_mask.nii,1',route)};
matlabbatch{17}.spm.util.voi.roi{2}.mask.threshold = 0.5;
matlabbatch{17}.spm.util.voi.expression = 'i1&i2';
matlabbatch{18}.spm.util.voi.spmmat = {sprintf('%s/models/glmN-DCT/SPM.mat',route)};
...
matlabbatch{18}.spm.util.voi.roi{2}.mask.image = {sprintf('%s/masks/adjusted_s-rfMRI_mask.nii,1',route)};
matlabbatch{18}.spm.util.voi.roi{2}.mask.threshold = 0.5;
matlabbatch{18}.spm.util.voi.expression = 'i1&i2';
matlabbatch{19}.spm.util.voi.spmmat = {sprintf('%s/models/glmN-DCT/SPM.mat',route)};
...
matlabbatch{19}.spm.util.voi.roi{2}.mask.image = {sprintf('%s/masks/adjusted_s-rfMRI_mask.nii,1',route)};
matlabbatch{19}.spm.util.voi.roi{2}.mask.threshold = 0.5;
matlabbatch{19}.spm.util.voi.expression = 'i1&i2';
matlabbatch{20}.spm.util.voi.spmmat = {sprintf('%s/models/glmN-DCT/SPM.mat',route)};
...
matlabbatch{20}.spm.util.voi.roi{2}.mask.image = {sprintf('%s/masks/adjusted_s-rfMRI_mask.nii,1',route)};
matlabbatch{20}.spm.util.voi.roi{2}.mask.threshold = 0.5;
matlabbatch{20}.spm.util.voi.expression = 'i1&i2';
matlabbatch{21}.spm.util.voi.spmmat = {sprintf('%s/models/glmN-DCT/SPM.mat',route)};
...
matlabbatch{21}.spm.util.voi.roi{2}.mask.image = {sprintf('%s/masks/adjusted_s-rfMRI_mask.nii,1',route)};
