...
for t=1:410
    v_pad = sprintf('%04d',t);
    timeseriesIm = niftiread(sprintf('%s/models/glmNR2/Res_%s.nii',route,v_pad));
    for x=1:91
        for y=1:109
            for z=1:91
...
matlabbatch{1}.spm.util.voi.spmmat = {sprintf('%s/models/glmNR2/SPM.mat',route)};
...
matlabbatch{2}.spm.util.voi.spmmat = {sprintf('%s/models/glmNR2/SPM.mat',route)};
...
matlabbatch{3}.spm.util.voi.spmmat = {sprintf('%s/models/glmNR2/SPM.mat',route)};
...
matlabbatch{4}.spm.util.voi.spmmat = {sprintf('%s/models/glmNR2/SPM.mat',route)};
...
matlabbatch{5}.spm.util.voi.spmmat = {sprintf('%s/models/glmNR2/SPM.mat',route)};
...
matlabbatch{6}.spm.util.voi.spmmat = {sprintf('%s/models/glmNR2/SPM.mat',route)};
...
matlabbatch{7}.spm.util.voi.spmmat = {sprintf('%s/models/glmNR2/SPM.mat',route)};
...
matlabbatch{8}.spm.util.voi.spmmat = {sprintf('%s/models/glmNR2/SPM.mat',route)};
...
matlabbatch{9}.spm.util.voi.spmmat = {sprintf('%s/models/glmNR2/SPM.mat',route)};
...
matlabbatch{10}.spm.util.voi.spmmat = {sprintf('%s/models/glmNR2/SPM.mat',route)};
...
matlabbatch{11}.spm.util.voi.spmmat = {sprintf('%s/models/glmNR2/SPM.mat',route)};
...
matlabbatch{12}.spm.util.voi.spmmat = {sprintf('%s/models/glmNR2/SPM.mat',route)};
...
matlabbatch{13}.spm.util.voi.spmmat = {sprintf('%s/models/glmNR2/SPM.mat',route)};
...
matlabbatch{14}.spm.util.voi.spmmat = {sprintf('%s/models/glmNR2/SPM.mat',route)};
...
matlabbatch{15}.spm.util.voi.spmmat = {sprintf('%s/models/glmNR2/SPM.mat',route)};
...
matlabbatch{16}.spm.util.voi.spmmat = {sprintf('%s/models/glmNR2/SPM.mat',route)};
...
matlabbatch{17}.spm.util.voi.spmmat = {sprintf('%s/models/glmNR2/SPM.mat',route)};
...
matlabbatch{18}.spm.util.voi.spmmat = {sprintf('%s/models/glmNR2/SPM.mat',route)};
...
matlabbatch{19}.spm.util.voi.spmmat = {sprintf('%s/models/glmNR2/SPM.mat',route)};
...
matlabbatch{20}.spm.util.voi.spmmat = {sprintf('%s/models/glmNR2/SPM.mat',route)};
...
matlabbatch{21}.spm.util.voi.spmmat = {sprintf('%s/models/glmNR2/SPM.mat',route)};
